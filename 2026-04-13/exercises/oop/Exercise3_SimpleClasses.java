...
public class Exercise3_SimpleClasses {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Initial balance: " + currencyFormat.format(account.getBalance()));
        account.deposit(500);
        System.out.println("After deposit: " + currencyFormat.format(account.getBalance()));
        account.withdraw(200);
        System.out.println("After withdrawal: " + currencyFormat.format(account.getBalance()));
        account.withdraw(2000); // Should fail
        System.out.println("After failed withdrawal: " + currencyFormat.format(account.getBalance()));
